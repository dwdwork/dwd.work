...
function dwd_scripts() {
    ...
    wp_enqueue_style('dwd-bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.min.css');
    ...
    // Enqueue js.
    wp_enqueue_script('dwd-bootstrap', get_template_directory_uri() . '/assets/js/vendor/bootstrap.bundle.min.js');
